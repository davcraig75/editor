# ITG Vega Editor [![Build Status](https://travis-ci.org/vega/editor.svg?branch=master)](https://travis-ci.org/vega/editor) [![Greenkeeper badge](https://badges.greenkeeper.io/vega/editor.svg)](https://greenkeeper.io/)
